          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <div className="relative aspect-square bg-gray-100 rounded-xl overflow-hidden">
                <Image
                  src="/scrabed data/recrutment/IPHONE_13_128_Go.jpg"
            ...
            <div>
              <h2 className="text-3xl font-bold mb-6 text-gray-900">
                IPHONE 13 - Description Complète
              </h2>
              
              <div className="prose prose-lg text-gray-700 mb-8">
                <p className="mb-4">Iphone 13 128 Go
      ...
      <section className="py-16 bg-gradient-to-r from-blue-600 to-rose-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 opacity-90">
            Contactez-nous dès maintenant pour réserver votre IPHONE 13 reconditionné
          </p>
