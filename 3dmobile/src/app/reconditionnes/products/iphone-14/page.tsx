          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <div className="relative aspect-square bg-gray-100 rounded-xl overflow-hidden">
                <Image
                  src="/scrabed data/recrutment/IPHONE_14_128_Go.jpg"
                  alt="IPHONE 14 reconditionné"
                  fill
            ...
            <div>
              <h2 className="text-3xl font-bold mb-6 text-gray-900">
                IPHONE 14 - Description Complète
              </h2>
              
              <div className="prose prose-lg text-gray-700 mb-8">
                <p className="mb-4">IPHONE 14 128GO 
      ...
      <section className="py-16 bg-gradient-to-r from-blue-600 to-rose-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 opacity-90">
            Contactez-nous dès maintenant pour réserver votre IPHONE 14 reconditionné
          </p>
