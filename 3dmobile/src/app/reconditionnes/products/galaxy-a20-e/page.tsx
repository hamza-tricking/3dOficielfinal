...
export default function GALAXYA20E() {
  return (
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <h2 className="text-3xl font-bold mb-6 text-gray-900">
                GALAXY A20 E - Description Complète
              </h2>
              
              <div className="prose prose-lg text-gray-700 mb-8">
                <p className="mb-4">SAMSUNG GALAXY A20 E 32GO
      ...
      <section className="py-16 bg-gradient-to-r from-blue-600 to-rose-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 opacity-90">
            Contactez-nous dès maintenant pour réserver votre GALAXY A20 E reconditionné
          </p>
