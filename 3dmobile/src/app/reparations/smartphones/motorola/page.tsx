...
const motorolaModels: MotorolaModel[] = [
  { name: "MOTO E22", image: "MOTO_E22_image.jpg", path: "moto-e22" },
  { name: "MOTO E22i", image: "MOTO_E22i_image.jpg", path: "moto-e22i" },
  { name: "MOTO E32", image: "MOTO_E32_image.jpg", path: "moto-e32" },
  { name: "MOTO E32S", image: "MOTO_E32S_image.jpg", path: "moto-e32s" },
  { name: "MOTO E7i POWER", image: "MOTO_E7i_POWER_image.png", path: "moto-e7i-power" },
  { name: "MOTO G 5G PLUS", image: "MOTO_G_5G_PLUS_image.jpeg", path: "moto-g-5g-plus" },
  { name: "MOTO G10", image: "MOTO_G10_image.png", path: "moto-g10" },
  { name: "MOTO G22", image: "MOTO_G22_image.jpg", path: "moto-g22" },
  { name: "MOTO G30", image: "MOTO_G30_image.png", path: "moto-g30" },
  { name: "MOTO G31", image: "MOTO_G31_image.png", path: "moto-g31" },
  { name: "MOTO G32", image: "MOTO_G32_image.jpg", path: "moto-g32" },
  { name: "MOTO G42", image: "MOTO_G42_image.jpg", path: "moto-g42" },
  { name: "MOTO G50", image: "MOTO_G50_image.png", path: "moto-g50" },
  { name: "MOTO G52", image: "MOTO_G52_image.png", path: "moto-g52" },
  { name: "MOTO G62 5G", image: "MOTO_G62_5G_image.jpg", path: "moto-g62-5g" },
  { name: "MOTO G72", image: "MOTO_G72_image.jpg", path: "moto-g72" },
  { name: "MOTO G8 PLUS", image: "MOTO_G8_PLUS_image.png", path: "moto-g8-plus" },
  { name: "MOTO G8 POWER", image: "MOTO_G8_POWER_image.png", path: "moto-g8-power" },
  { name: "MOTO G8 POWER LITE", image: "MOTO_G8_POWER_LITE_image.png", path: "moto-g8-power-lite" },
  { name: "MOTO G82 5G", image: "MOTO_G82_5G_image.jpg", path: "moto-g82-5g" },
  { name: "MOTO G84 5G", image: "MOTO_G84_5G_image.webp", path: "moto-g84-5g" },
  { name: "MOTO G9 PLAY", image: "MOTO_G9_PLAY_image.png", path: "moto-g9-play" },
  { name: "MOTO G9 PLUS", image: "MOTO_G9_PLUS_image.png", path: "moto-g9-plus" },
  { name: "MOTO G9 POWER", image: "MOTO_G9_POWER_image.png", path: "moto-g9-power" }
];

export default function MotorolaModels() {
  return (
        ...
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center py-4">
            ...
            <ul className="hidden md:flex space-x-6">
              ...
              <li><Link href="/reparations/smartphones/motorola" className="text-gray-800 hover:text-blue-600 font-semibold transition-colors duration-300 relative group">
                Motorola
                <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-blue-600 transition-all duration-300 group-hover:w-full"></span>
              </Link></li>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center">
            ...
            <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
              Expert en réparation de tous les modèles Motorola à Saint-Nazaire
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4 text-gray-800">
              Choisissez votre modèle Motorola
            </h2>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
            {motorolaModels.map((model) => (
              <Link 
                key={model.path}
                href={`/reparations/smartphones/motorola/${model.path}`}
              ...
              >
                <div className="aspect-square mb-4 overflow-hidden rounded-lg bg-gray-50 flex items-center justify-center">
                  <Image
                    src={`/scrabed data/smartphones repaire/repair_data_motorola/${model.image}`}
                    alt={model.name}
                    width={120}
                    height={120}
      ...
      <section className="py-16 bg-gray-800 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-6">
            Votre Motorola est en Panne ?
          </h2>
          <p className="text-xl mb-8">
            Nos experts Motorola vous attendent pour un diagnostic rapide et une réparation de qualité.
          </p>
      ...
      <footer className="bg-gray-800 text-gray-300 py-12">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-gray-400 mb-8 max-w-2xl mx-auto leading-relaxed">
            Votre expert en réparation Motorola à Saint-Nazaire
          </p>
