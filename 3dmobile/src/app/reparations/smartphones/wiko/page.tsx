...
const wikoModels: WikoModel[] = [
  { name: "POWER U10", image: "POWER_U10_image.png", path: "power-u10" },
  { name: "POWER U20", image: "POWER_U20_image.jpg", path: "power-u20" },
  { name: "POWER U30", image: "POWER_U30_image.jpg", path: "power-u30" },
  { name: "VIEW 3", image: "VIEW_3_image.png", path: "view-3" },
  { name: "VIEW 3 LITE", image: "VIEW_3_LITE_image.png", path: "view-3-lite" },
  { name: "VIEW 3 PRO", image: "VIEW_3_PRO_image.png", path: "view-3-pro" },
  { name: "VIEW 4", image: "VIEW_4_image.png", path: "view-4" },
  { name: "VIEW 4 LITE", image: "VIEW_4_LITE_image.png", path: "view-4-lite" },
  { name: "VIEW 5", image: "VIEW_5_image.png", path: "view-5" },
  { name: "VIEW 5 PLUS", image: "VIEW_5_PLUS_image.png", path: "view-5-plus" },
  { name: "Y50", image: "Y50_image.png", path: "y50" },
  { name: "Y51", image: "Y51_image.png", path: "y51" },
  { name: "Y61", image: "Y61_image.png", path: "y61" },
  { name: "Y62", image: "Y62_image.png", path: "y62" },
  { name: "Y80", image: "Y80_image.png", path: "y80" },
  { name: "Y81", image: "Y81_image.png", path: "y81" }
];

export default function WikoModels() {
  return (
        ...
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center py-4">
            ...
            <ul className="hidden md:flex space-x-6">
              ...
              <li><Link href="/reparations/smartphones/wiko" className="text-gray-800 hover:text-blue-600 font-semibold transition-colors duration-300 relative group">
                Wiko
                <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-blue-600 transition-all duration-300 group-hover:w-full"></span>
              </Link></li>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center">
            ...
            <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
              Expert en réparation de tous les modèles Wiko à Saint-Nazaire
            </p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
            {wikoModels.map((model) => (
              <Link 
                key={model.path}
                href={`/reparations/smartphones/wiko/${model.path}`}
              ...
              >
                <div className="aspect-square mb-4 overflow-hidden rounded-lg bg-gray-50 flex items-center justify-center">
                  <Image
                    src={`/scrabed data/smartphones repaire/repair_data_wiko/${model.image}`}
                    alt={model.name}
                    width={120}
                    height={120}
      ...
      <section className="py-16 bg-gray-800 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-6">
            Votre Wiko est en Panne ?
          </h2>
          <p className="text-xl mb-8">
            Nos experts Wiko vous attendent pour un diagnostic rapide et une réparation de qualité.
          </p>
      ...
      <footer className="bg-gray-800 text-gray-300 py-12">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-gray-400 mb-8 max-w-2xl mx-auto leading-relaxed">
            Votre expert en réparation Wiko à Saint-Nazaire
          </p>
