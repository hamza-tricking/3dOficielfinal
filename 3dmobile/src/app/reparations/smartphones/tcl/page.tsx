...
const tCLModels: TCLModel[] = [
  { name: "10 L", image: "10_L_image.jpg", path: "10-l" },
  { name: "10 PLUS", image: "10_PLUS_image.jpg", path: "10-plus" },
  { name: "10 PRO", image: "10_PRO_image.png", path: "10-pro" },
  { name: "10 SE", image: "10_SE_image.jpg", path: "10-se" },
  { name: "20 L", image: "20_L_image.jpeg", path: "20-l" },
  { name: "20 L PLUS", image: "20_L_PLUS_image.jpeg", path: "20-l-plus" },
  { name: "20 PRO 5G", image: "20_PRO_5G_image.jpg", path: "20-pro-5g" },
  { name: "20 R 5G", image: "20_R_5G_image.jpeg", path: "20-r-5g" },
  { name: "20 SE", image: "20_SE_image.jpg", path: "20-se" },
  { name: "30", image: "30_image.jpg", path: "30" },
  { name: "30 PLUS", image: "30_PLUS_image.jpg", path: "30-plus" },
  { name: "30 SE", image: "30_SE_image.jpg", path: "30-se" }
];

export default function TCLModels() {
  return (
        ...
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center py-4">
            ...
            <ul className="hidden md:flex space-x-6">
              ...
              <li><Link href="/reparations/smartphones/tcl" className="text-gray-800 hover:text-blue-600 font-semibold transition-colors duration-300 relative group">
                TCL
                <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-blue-600 transition-all duration-300 group-hover:w-full"></span>
              </Link></li>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center">
            ...
            <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
              Expert en réparation de tous les modèles TCL à Saint-Nazaire
            </p>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
            {tCLModels.map((model) => (
              <Link 
                key={model.path}
                href={`/reparations/smartphones/tcl/${model.path}`}
              ...
              >
                <div className="aspect-square mb-4 overflow-hidden rounded-lg bg-gray-50 flex items-center justify-center">
                  <Image
                    src={`/scrabed data/smartphones repaire/repair_data_tcl/${model.image}`}
                    alt={model.name}
                    width={120}
                    height={120}
      ...
      <section className="py-16 bg-gray-800 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-6">
            Votre TCL est en Panne ?
          </h2>
          <p className="text-xl mb-8">
            Nos experts TCL vous attendent pour un diagnostic rapide et une réparation de qualité.
          </p>
      ...
      <footer className="bg-gray-800 text-gray-300 py-12">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-gray-400 mb-8 max-w-2xl mx-auto leading-relaxed">
            Votre expert en réparation TCL à Saint-Nazaire
          </p>
