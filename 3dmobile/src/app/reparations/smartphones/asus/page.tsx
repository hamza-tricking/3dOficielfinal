...
const asusModels: AsusModel[] = [
  { name: "ZENFONE 5 ZE620KL", image: "ZENFONE_5_ZE620KL_image.png", path: "zenfone-5-ze620kl" },
  { name: "ZENFONE 6 ZS630KL", image: "ZENFONE_6_ZS630KL_image.png", path: "zenfone-6-zs630kl" },
  { name: "ZENFONE 7 PRO ZS671KS", image: "ZENFONE_7_PRO_ZS671KS_image.png", path: "zenfone-7-pro-zs671ks" },
  { name: "ZENFONE 7 ZS670KS", image: "ZENFONE_7_ZS670KS_image.png", path: "zenfone-7-zs670ks" },
  { name: "ZENFONE 8 FLIP ZS672KS", image: "ZENFONE_8_FLIP_ZS672KS_image.png", path: "zenfone-8-flip-zs672ks" },
  { name: "ZENFONE 8 ZS590KS", image: "ZENFONE_8_ZS590KS_image.png", path: "zenfone-8-zs590ks" },
  { name: "ZENFONE 9", image: "ZENFONE_9_image.png", path: "zenfone-9" }
];

export default function AsusModels() {
  return (
        ...
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center py-4">
            ...
            <ul className="hidden md:flex space-x-6">
              ...
              <li><Link href="/reparations/smartphones/asus" className="text-gray-800 hover:text-blue-600 font-semibold transition-colors duration-300 relative group">
                Asus
                <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-blue-600 transition-all duration-300 group-hover:w-full"></span>
              </Link></li>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center">
            ...
            <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
              Expert en réparation de tous les modèles Asus à Saint-Nazaire
            </p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
            {asusModels.map((model) => (
              <Link 
                key={model.path}
                href={`/reparations/smartphones/asus/${model.path}`}
              ...
              >
                <div className="aspect-square mb-4 overflow-hidden rounded-lg bg-gray-50 flex items-center justify-center">
                  <Image
                    src={`/scrabed data/smartphones repaire/repair_data_asus/${model.image}`}
                    alt={model.name}
                    width={120}
                    height={120}
      ...
      <section className="py-16 bg-gray-800 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-6">
            Votre Asus est en Panne ?
          </h2>
          <p className="text-xl mb-8">
            Nos experts Asus vous attendent pour un diagnostic rapide et une réparation de qualité.
          </p>
      ...
      <footer className="bg-gray-800 text-gray-300 py-12">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-gray-400 mb-8 max-w-2xl mx-auto leading-relaxed">
            Votre expert en réparation Asus à Saint-Nazaire
          </p>
