        ...
        <div className="container mx-auto px-4">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-700 mb-8 max-w-3xl mx-auto">
              Experts en réparation de tous les modèles de smartphones à Saint-Nazaire
            </p>
            <div className="flex flex-col md:flex-row gap-4 justify-center items-center">
              <Link href="tel:0980677518" className="bg-blue-600 text-white px-8 py-3 rounded-full font-semibold hover:bg-blue-700 transition-colors">
                📞 Appeler maintenant
              </Link>
              <Link href="/contact" className="bg-white text-blue-600 border-2 border-blue-600 px-8 py-3 rounded-full font-semibold hover:bg-blue-50 transition-colors">
                📧 Demander un devis
              </Link>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <ServiceCard
              icon="📱"
              title="Écran Cassé"
              description="Remplacement d'écran original en moins d'une heure. Pièces certifiées avec garantie 6 mois."
              features={[
            ...
            <ServiceCard
              ...
              description="Désoxydation complète et récupération de données."
              features={[
                "Diagnostic immédiat",
                "Bains ultrasons",
                "Sauvegarde données",
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Analyse complète de votre appareil pour identifier le problème exact.
              </p>
            </div>
            <div className="text-center">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Intervention sur place en moins d'une heure pour la plupart des réparations.
              </p>
            </div>
            <div className="text-center">
              <div className="bg-rose-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
      ...
      <footer className="bg-gray-800 text-gray-300 py-12">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-gray-400 mb-8 max-w-2xl mx-auto leading-relaxed">
            Votre expert en réparation de smartphones à Saint-Nazaire
          </p>
