...
const vivoModels: VivoModel[] = [
  { name: "V21 5G", image: "V21_5G_image.jpg", path: "v21-5g" },
  { name: "V23 5G", image: "V23_5G_image.jpg", path: "v23-5g" },
  { name: "X51 5G", image: "X51_5G_image.webp", path: "x51-5g" },
  { name: "X60 PRO", image: "X60_PRO_image.webp", path: "x60-pro" },
  { name: "Y11S", image: "Y11S_image.jpg", path: "y11s" },
  { name: "Y21", image: "Y21_image.jpg", path: "y21" },
  { name: "Y21S", image: "Y21S_image.jpg", path: "y21s" },
  { name: "Y35", image: "Y35_image.jpg", path: "y35" },
  { name: "Y52 5G", image: "Y52_5G_image.jpg", path: "y52-5g" },
  { name: "Y55 5G", image: "Y55_5G_image.jpg", path: "y55-5g" },
  { name: "Y70", image: "Y70_image.webp", path: "y70" },
  { name: "Y72 5G", image: "Y72_5G_image.webp", path: "y72-5g" }
];

export default function VivoModels() {
  return (
        ...
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center py-4">
            ...
            <ul className="hidden md:flex space-x-6">
              ...
              <li><Link href="/reparations/smartphones/vivo" className="text-gray-800 hover:text-blue-600 font-semibold transition-colors duration-300 relative group">
                Vivo
                <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-blue-600 transition-all duration-300 group-hover:w-full"></span>
              </Link></li>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center">
            ...
            <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
              Expert en réparation de tous les modèles Vivo à Saint-Nazaire
            </p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
            {vivoModels.map((model) => (
              <Link 
                key={model.path}
                href={`/reparations/smartphones/vivo/${model.path}`}
              ...
              >
                <div className="aspect-square mb-4 overflow-hidden rounded-lg bg-gray-50 flex items-center justify-center">
                  <Image
                    src={`/scrabed data/smartphones repaire/repair_data_vivo/${model.image}`}
                    alt={model.name}
                    width={120}
                    height={120}
      ...
      <section className="py-16 bg-gray-800 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-6">
            Votre Vivo est en Panne ?
          </h2>
          <p className="text-xl mb-8">
            Nos experts Vivo vous attendent pour un diagnostic rapide et une réparation de qualité.
          </p>
      ...
      <footer className="bg-gray-800 text-gray-300 py-12">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-gray-400 mb-8 max-w-2xl mx-auto leading-relaxed">
            Votre expert en réparation Vivo à Saint-Nazaire
          </p>
