...
const repairServices = [
  { 
    id: "screen-lcd", 
    name: "Vitre + écran LCD compatible", 
    normalPrice: "69.00€ TTC", 
    discountPrice: "44.00€ TTC",
    duration: "1 heure" 
  },
  { 
    id: "screen-lcd-original", 
    name: "Vitre + écran LCD similaire à l'original", 
    normalPrice: "99.00€ TTC", 
    discountPrice: "74.00€ TTC",
    duration: "1 heure" 
  },
  { 
    id: "chassis-glass", 
    name: "Châssis complet + Vitre arrière", 
    normalPrice: "99.00€ TTC", 
    discountPrice: "74.00€ TTC",
    duration: "1 heure" 
  },
  { 
    id: "rear-camera-glass", 
    name: "Vitre camera arrière", 
    normalPrice: "39.00€ TTC", 
    discountPrice: "14.00€ TTC",
    duration: "30 minutes" 
  },
  { 
    id: "battery", 
    name: "Batterie", 
    normalPrice: "59.00€ TTC", 
    discountPrice: "34.00€ TTC",
    duration: "45 minutes" 
  },
  { 
    id: "charging-port", 
  ...
  { 
    ...
    normalPrice: "20.00€ TTC", 
    duration: "30 minutes" 
  },
  { 
    id: "data-recovery", 
    name: "Récupération de données", 
    normalPrice: "30.00€ TTC", 
    duration: "1-2 heures" 
  },
  { 
    id: "diagnostic", 
...
export default function iPhone8PlusPage() {
  ...
  const handleServiceNameClick = (serviceId: string) => {
    if (serviceId === "screen-lcd" || serviceId === "screen-lcd-original" || serviceId === "screen-oled") {
  ...
  const calculateTotal = () => {
    return selectedServices.reduce((total, serviceId) => {
      ...
      if (service.normalPrice === "GRATUIT") {
        servicePrice = 0;
      } else {
        servicePrice = service.discountPrice 
          ? parseFloat(service.discountPrice.replace('€ TTC', ''))
          : parseFloat(service.normalPrice.replace('€ TTC', ''));
      }
      
      const protection = selectedProtection[serviceId];
      if (protection === 'hydrogel') {
        servicePrice += 20;
      } else if (protection === 'verre-trempe') {
        servicePrice += 10;
      } else if (protection === 'avec-demontage') {
        servicePrice += 20;
      }
    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="container mx-auto px-4">
          <div className="text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6 text-white">
              Réparations Apple iPhone 8 Plus
            </h1>
            <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
              Expert en réparation du iPhone 8 Plus à Saint-Nazaire
            </p>
            <div className="flex flex-col md:flex-row gap-4 justify-center items-center">
              <a href="tel:0980677518" className="bg-white text-blue-600 px-8 py-3 rounded-full font-semibold hover:bg-blue-50 transition-colors">
              ...
              <Link href="/contact" className="bg-blue-600 text-white border-2 border-blue-600 px-8 py-3 rounded-full font-semibold hover:bg-blue-700 transition-colors">
                📧 Prendre rendez-vous 09 80 67 75 18
              </Link>
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-col md:flex-row items-center gap-8">
            <div className="md:w-1/2">
              <div className="bg-white rounded-2xl shadow-xl p-8">
                <Image
                  src="/scrabed data/smartphones repaire/repair_data_iphone/iphone_8_plus_image.png"
                  alt="iPhone 8 Plus"
                  width={400}
                  height={400}
            ...
            <div className="md:w-1/2">
              <h2 className="text-3xl font-bold mb-6 text-gray-800">
                Obtenez une réparation rapide pour votre appareil Apple iPhone 8 Plus à Saint-Nazaire !
              </h2>
              <p className="text-lg text-gray-600 mb-4">
                Si votre iPhone 8 Plus ne s'allume plus, présente un écran fissuré, des problèmes d'appels ou des problèmes de charge, ne vous inquiétez pas ! Nos experts en réparation sont là pour vous offrir leur assistance et restaurer votre appareil à son plein potentiel.
              </p>
              <p className="text-lg text-gray-600 mb-4">
                Nos techniciens effectuent un diagnostic complet de votre iPhone 8 Plus de manière rapide et précise, vous fournissant ainsi les détails de la panne et les coûts de réparation. Avec une moyenne de plus de 450 réparations par mois dans nos boutiques, nous sommes en mesure de choisir les meilleures pièces de remplacement à des prix compétitifs, notamment pour les écrans et les batteries.
              </p>
              <p className="text-lg text-gray-600">
                Associé à la formation de nos techniciens et réparateurs, confier la réparation de votre smartphone à 3DMobile garantit une remise en état de votre appareil en 1 heure pour la plupart des problèmes rencontrés. Nous prenons en charge directement en boutique et en temps réel 100% des pannes que votre appareil iPhone 8 Plus pourrait rencontrer.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Sélectionnez les réparations dont vous avez besoin
            </p>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-white border border-gray-200 rounded-lg overflow-hidden">
              <ScreenRepairService
                ...
                discountPrice="44.00€ TTC"
                duration="1 heure"
                isSelected={selectedServices.includes("screen-lcd")}
                selectedProtection={selectedProtection["screen-lcd"]}
              ...
              <ScreenRepairService
                ...
                discountPrice="74.00€ TTC"
                duration="1 heure"
                isSelected={selectedServices.includes("screen-lcd-original")}
                selectedProtection={selectedProtection["screen-lcd-original"]}
                onToggle={handleServiceToggle}
                onProtectionSelect={handleProtectionSelect}
              />
              <StandardService
                ...
                discountPrice="74.00€ TTC"
                duration="1 heure"
                isSelected={selectedServices.includes("chassis-glass")}
                onToggle={handleServiceToggle}
              />
              <StandardService
                id="rear-camera-glass"
                ...
                discountPrice="14.00€ TTC"
                duration="30 minutes"
                isSelected={selectedServices.includes("rear-camera-glass")}
                onToggle={handleServiceToggle}
              />
              <StandardService
                id="battery"
                ...
                discountPrice="34.00€ TTC"
                duration="45 minutes"
                isSelected={selectedServices.includes("battery")}
                onToggle={handleServiceToggle}
              />
              <StandardService
                id="charging-port"
                ...
                discountPrice="34.00€ TTC"
                duration="30 minutes"
                isSelected={selectedServices.includes("charging-port")}
                onToggle={handleServiceToggle}
              />
              <StandardService
                id="power-button"
                ...
                normalPrice="49.00€ TTC"
                duration="30 minutes"
                isSelected={selectedServices.includes("power-button")}
                onToggle={handleServiceToggle}
              />
              <StandardService
                id="volume-button"
                ...
                normalPrice="49.00€ TTC"
                duration="30 minutes"
                isSelected={selectedServices.includes("volume-button")}
                onToggle={handleServiceToggle}
              />
              <StandardService
                id="front-camera"
                ...
                discountPrice="24.00€ TTC"
                duration="30 minutes"
                isSelected={selectedServices.includes("front-camera")}
                onToggle={handleServiceToggle}
              />
              <StandardService
                id="rear-camera"
                ...
                discountPrice="44.00€ TTC"
                duration="30 minutes"
                isSelected={selectedServices.includes("rear-camera")}
                onToggle={handleServiceToggle}
              />
              <StandardService
                id="vibrator"
                ...
                normalPrice="39.00€ TTC"
                duration="30 minutes"
                isSelected={selectedServices.includes("vibrator")}
                onToggle={handleServiceToggle}
              />
              <StandardService
                id="microphone"
                ...
                discountPrice="34.00€ TTC"
                duration="30 minutes"
                isSelected={selectedServices.includes("microphone")}
                onToggle={handleServiceToggle}
              />
              <StandardService
                id="earpiece"
                ...
                discountPrice="14.00€ TTC"
                duration="30 minutes"
                isSelected={selectedServices.includes("earpiece")}
                onToggle={handleServiceToggle}
              />
              <StandardService
                id="speaker"
                ...
                discountPrice="14.00€ TTC"
                duration="30 minutes"
                isSelected={selectedServices.includes("speaker")}
                onToggle={handleServiceToggle}
              />
              <StandardService
                id="nfc-cover"
                ...
                normalPrice="49.00€ TTC"
                duration="30 minutes"
                isSelected={selectedServices.includes("nfc-cover")}
                onToggle={handleServiceToggle}
              />
              <StandardService
                id="wifi-antenna"
                ...
                normalPrice="10.00€ TTC"
                duration="30 minutes"
                isSelected={selectedServices.includes("wifi-antenna")}
                onToggle={handleServiceToggle}
              />
              <StandardService
                id="sim-tray"
                ...
                normalPrice="10.00€ TTC"
                duration="15 minutes"
                isSelected={selectedServices.includes("sim-tray")}
                onToggle={handleServiceToggle}
              />
              <StandardService
                id="deoxidation"
                ...
                normalPrice="49.00€ TTC"
                duration="1 heure"
                isSelected={selectedServices.includes("deoxidation")}
                onToggle={handleServiceToggle}
              />
              <StandardService
                id="data-transfer"
                ...
                normalPrice="20.00€ TTC"
                duration="30 minutes"
                isSelected={selectedServices.includes("data-transfer")}
                onToggle={handleServiceToggle}
              />
              <DataRecoveryService
                id="data-recovery"
                ...
                normalPrice="30.00€ TTC"
                duration="1-2 heures"
                isSelected={selectedServices.includes("data-recovery")}
                selectedRecoveryType={selectedProtection["data-recovery"]}
                onToggle={handleServiceToggle}
              ...
              <StandardService
                ...
                normalPrice="GRATUIT"
                duration="15 minutes"
                isSelected={selectedServices.includes("diagnostic")}
                onToggle={handleServiceToggle}
              />
            </div>
            ...
            {selectedServices.length > 0 && (
              <div className="mt-8 p-6 bg-blue-50 rounded-lg border border-blue-200">
                ...
                <div className="mb-4">
                  ...
                  <ul className="space-y-1">
                    {selectedServices.map(serviceId => {
                      ...
                      if (protection === 'hydrogel') {
                        serviceName += ' (Film Hydrogel)';
                        servicePrice = servicePrice.replace('€ TTC', '') + ' + 20€ TTC';
                      } else if (protection === 'verre-trempe') {
                        serviceName += ' (Verre trempé)';
                        servicePrice = servicePrice.replace('€ TTC', '') + ' + 10€ TTC';
                      } else if (protection === 'avec-demontage') {
                        serviceName += ' (Avec démontage)';
                        servicePrice = servicePrice.replace('€ TTC', '') + ' + 20€ TTC';
                      }
                ...
                <div className="flex gap-4">
                  <a href="tel:0980677518" className="bg-blue-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-blue-700 transition-colors">
                    📞 Appeler pour prendre rendez-vous
                  </a>
                  <Link href="/contact" className="bg-white text-blue-600 border-2 border-blue-600 px-6 py-3 rounded-lg font-semibold hover:bg-blue-50 transition-colors">
      ...
      <footer className="bg-gray-800 text-gray-300 py-12">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-gray-400 mb-8 max-w-2xl mx-auto leading-relaxed">
            Votre expert en réparation iPhone 8 Plus à Saint-Nazaire
          </p>
      ...
      {showScreenProtectionModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          <div 
            ...
            onClick={() => setShowScreenProtectionModal(null)}
          />
          <div className="relative bg-white rounded-2xl shadow-2xl p-6 max-w-sm w-full mx-4 transform transition-all">
            ...
            <div className="space-y-2">
              <label className="flex items-center justify-between p-3 border-2 border-gray-200 rounded-lg hover:border-blue-400 hover:bg-blue-50 transition-all duration-200 cursor-pointer group">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-gray-500">Protection maximale</div>
                  </div>
                </div>
              ...
              <label className="flex items-center justify-between p-3 border-2 border-gray-200 rounded-lg hover:border-blue-400 hover:bg-blue-50 transition-all duration-200 cursor-pointer group">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-gray-500">Protection standard</div>
                  </div>
                </div>
              ...
              <label className="flex items-center justify-between p-3 border-2 border-gray-200 rounded-lg hover:border-blue-400 hover:bg-blue-50 transition-all duration-200 cursor-pointer group">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-gray-500">Aucune protection</div>
                  </div>
                </div>
            ...
            <div className="flex gap-3 mt-6">
              <button
                onClick={() => setShowScreenProtectionModal(null)}
                className="flex-1 bg-gray-200 text-gray-800 px-4 py-2 rounded-lg font-semibold hover:bg-gray-300 transition-colors text-sm"
              >
                Annuler
              </button>
              <button
                onClick={() => {
                  ...
                  if (selected) {
                    handleProtectionSelect(showScreenProtectionModal, selected.value);
                  }
                }}
      ...
      {showDataRecoveryModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          <div 
            className="absolute inset-0 bg-black/50 bg-opacity-50 backdrop-blur-sm"
            onClick={() => setShowDataRecoveryModal(null)}
          />
          <div className="relative bg-white rounded-2xl shadow-2xl p-6 max-w-sm w-full mx-4 transform transition-all">
            <h2 className="text-xl font-bold mb-4 text-gray-800 text-center">
              ...
              <label className="flex items-center justify-between p-3 border-2 border-gray-200 rounded-lg hover:border-blue-400 hover:bg-blue-50 transition-all duration-200 cursor-pointer group">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-gray-500">Appareil fonctionnel</div>
                  </div>
                </div>
              ...
              <label className="flex items-center justify-between p-3 border-2 border-gray-200 rounded-lg hover:border-blue-400 hover:bg-blue-50 transition-all duration-200 cursor-pointer group">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-gray-500">Appareil endommagé</div>
                  </div>
                </div>
                <span className="text-base font-bold text-blue-600">+20€</span>
              </label>
            ...
            <div className="flex gap-3 mt-6">
              ...
              <button
                onClick={() => {
                  ...
                  if (selected) {
                    handleDataRecoverySelect(showDataRecoveryModal, selected.value);
                  }
                }}
                className="flex-1 bg-blue-600 text-white px-4 py-2 rounded-lg font-semibold hover:bg-blue-700 transition-colors text-sm"
              >
      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 bg-blue-600 text-white px-4 py-3 shadow-lg border-t border-blue-700">
        <div className="container mx-auto flex justify-between items-center">
          ...
          <div className="flex gap-3">
            <a href="tel:0980677518" className="bg-white text-blue-600 px-4 py-2 rounded-lg font-semibold hover:bg-blue-50 transition-colors text-sm">
              📞 Appeler
            </a>
            <Link href="/contact" className="bg-blue-700 text-white px-4 py-2 rounded-lg font-semibold hover:bg-blue-800 transition-colors text-sm">
              📧 Contacter
            </Link>
          </div>
        </div>
