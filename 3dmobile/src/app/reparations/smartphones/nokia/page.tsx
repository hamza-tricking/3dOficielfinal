...
interface NokiaModel {
  name: string;
  image: string;
  path: string;
}

const nokiaModels: NokiaModel[] = [
  { name: "NOKIA 5", image: "NOKIA_5_image.png", path: "nokia-5" },
  { name: "NOKIA 51", image: "NOKIA_51_image.png", path: "nokia-51" },
  { name: "NOKIA 51 PLUS", image: "NOKIA_51_PLUS_image.png", path: "nokia-51-plus" },
  { name: "NOKIA 53", image: "NOKIA_53_image.png", path: "nokia-53" },
  { name: "NOKIA 6", image: "NOKIA_6_image.png", path: "nokia-6" },
  { name: "NOKIA 61", image: "NOKIA_61_image.png", path: "nokia-61" },
  { name: "NOKIA 7", image: "NOKIA_7_image.png", path: "nokia-7" },
  { name: "NOKIA 71", image: "NOKIA_71_image.png", path: "nokia-71" },
  { name: "NOKIA 72", image: "NOKIA_72_image.png", path: "nokia-72" },
  { name: "NOKIA 8", image: "NOKIA_8_image.png", path: "nokia-8" },
  { name: "NOKIA 81", image: "NOKIA_81_image.png", path: "nokia-81" },
  { name: "NOKIA 83 5G", image: "NOKIA_83_5G_image.png", path: "nokia-83-5g" },
  { name: "NOKIA G10", image: "NOKIA_G10_image.png", path: "nokia-g10" },
  { name: "NOKIA G20", image: "NOKIA_G20_image.jpg", path: "nokia-g20" },
  { name: "NOKIA G50", image: "NOKIA_G50_image.jpg", path: "nokia-g50" }
];

export default function NokiaModels() {
  return (
        ...
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center py-4">
            ...
            <ul className="hidden md:flex space-x-6">
              ...
              <li><Link href="/reparations/smartphones/nokia" className="text-gray-800 hover:text-blue-600 font-semibold transition-colors duration-300 relative group">
                Nokia
                <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-blue-600 transition-all duration-300 group-hover:w-full"></span>
              </Link></li>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center">
            ...
            <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
              Expert en réparation de tous les modèles Nokia à Saint-Nazaire
            </p>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
            {nokiaModels.map((model) => (
              <Link 
                key={model.path}
                href={`/reparations/smartphones/nokia/${model.path}`}
              ...
              >
                <div className="aspect-square mb-4 overflow-hidden rounded-lg bg-gray-50 flex items-center justify-center">
                  <Image
                    src={`/scrabed data/smartphones repaire/repair_data_nokia/${model.image}`}
                    alt={model.name}
                    width={120}
                    height={120}
      ...
      <section className="py-16 bg-gray-800 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-6">
            Votre Nokia est en Panne ?
          </h2>
          <p className="text-xl mb-8">
            Nos experts Nokia vous attendent pour un diagnostic rapide et une réparation de qualité.
          </p>
      ...
      <footer className="bg-gray-800 text-gray-300 py-12">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-gray-400 mb-8 max-w-2xl mx-auto leading-relaxed">
            Votre expert en réparation Nokia à Saint-Nazaire
          </p>
