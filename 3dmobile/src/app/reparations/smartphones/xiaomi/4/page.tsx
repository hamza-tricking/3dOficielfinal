...
const repairServices = [
  { id: "glass-ecran-origine", name: "Vitre + Ecran Origine", normalPrice: "389.00€ TTC", discountPrice: "364.00€ TTC", duration: "30 minutes" },
...
export default function Xiaomi4Page() {
          ...
          <div className="flex flex-col md:flex-row items-center gap-8">
            <div className="md:w-1/2">
              <div className="bg-white rounded-2xl shadow-xl p-8">
                <Image src="/scrabed data/smartphones repaire/repair_data_xiaomi/default.png" alt="4" width={400} height={400} className="w-full h-auto object-contain" />
              </div>
            </div>
            <div className="md:w-1/2">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-white border border-gray-200 rounded-lg overflow-hidden">
              <ScreenRepairService id="glass-ecran-origine" name="Vitre + Ecran Origine" normalPrice="389.00€ TTC" discountPrice="364.00€ TTC" duration="30 minutes" isSelected={selectedServices.includes("glass-ecran-origine")} selectedProtection={selectedProtection["glass-ecran-origine"]} onToggle={handleServiceToggle} onProtectionSelect={handleProtectionSelect} />
