...
const repairServices = [
  { id: "glass-cran-compatible", name: "Vitre + écran compatible", normalPrice: "79.00€ TTC", discountPrice: "54.00€ TTC", duration: "30 minutes" },
  { id: "glass-cran-original-xiaomi", name: "Vitre + écran Original Xiaomi", normalPrice: "129.00€ TTC", discountPrice: "104.00€ TTC", duration: "30 minutes" },
  { id: "glass-arrire", name: "Vitre arrière", normalPrice: "49.00€ TTC", discountPrice: "24.00€ TTC", duration: "30 minutes" },
  { id: "glass-camera-arrire", name: "Vitre camera arrière", normalPrice: "39.00€ TTC", discountPrice: "14.00€ TTC", duration: "30 minutes" },
  { id: "battery", name: "Batterie", normalPrice: "39.00€ TTC", discountPrice: "14.00€ TTC", duration: "45 minutes" },
  { id: "charging-port-de-charge", name: "Connecteur de charge", normalPrice: "39.00€ TTC", discountPrice: "14.00€ TTC", duration: "30 minutes" },
  { id: "button-home", name: "Bouton home", normalPrice: "39.00€ TTC", duration: "30 minutes" },
  { id: "button-power", name: "Bouton power", normalPrice: "39.00€ TTC", duration: "30 minutes" },
  { id: "button-volume", name: "Bouton volume", normalPrice: "39.00€ TTC", duration: "30 minutes" },
  { id: "camra-avant", name: "Caméra avant", normalPrice: "39.00€ TTC", discountPrice: "14.00€ TTC", duration: "30 minutes" },
  { id: "camra-arrire", name: "Caméra arrière", normalPrice: "49.00€ TTC", discountPrice: "24.00€ TTC", duration: "30 minutes" },
  { id: "lecteur-empreinte", name: "lecteur empreinte", normalPrice: "39.00€ TTC", duration: "30 minutes" },
  { id: "microphone", name: "Micro", normalPrice: "39.00€ TTC", discountPrice: "14.00€ TTC", duration: "30 minutes" },
  { id: "ecouteur-interne", name: "Ecouteur interne", normalPrice: "39.00€ TTC", discountPrice: "14.00€ TTC", duration: "30 minutes" },
  { id: "speaker", name: "Haut parleur", normalPrice: "39.00€ TTC", discountPrice: "14.00€ TTC", duration: "30 minutes" },
  { id: "prise-casque", name: "Prise casque", normalPrice: "39.00€ TTC", duration: "30 minutes" },
...
export default function RedmiNote8ProPage() {
    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center py-4">
            ...
            <ul className="hidden md:flex space-x-6">
              ...
              <li><Link href="/reparations/smartphones/xiaomi" className="text-gray-800 hover:text-blue-600 font-semibold transition-colors">Xiaomi</Link></li>
      ...
      <section className="bg-gradient-to-br from-blue-600 to-blue-800 py-16">
        <div className="container mx-auto px-4">
          <div className="text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6 text-white">Réparations REDMI NOTE 8 PRO</h1>
            <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">Expert en réparation du REDMI NOTE 8 PRO à Saint-Nazaire</p>
          ...
          <div className="flex flex-col md:flex-row items-center gap-8">
            <div className="md:w-1/2">
              <div className="bg-white rounded-2xl shadow-xl p-8">
                <Image src="/scrabed data/smartphones repaire/repair_data_xiaomi/REDMI_NOTE_8_PRO_image.png" alt="REDMI NOTE 8 PRO" width={400} height={400} className="w-full h-auto object-contain" />
              </div>
            </div>
            <div className="md:w-1/2">
              <h2 className="text-3xl font-bold mb-6 text-gray-800">Obtenez une réparation rapide pour votre appareil REDMI NOTE 8 PRO à Saint-Nazaire !</h2>
              <p className="text-lg text-gray-600 mb-4">Si votre REDMI NOTE 8 PRO ne s'allume plus, présente un écran fissuré, des problèmes d'appels ou des problèmes de charge, ne vous inquiétez pas ! Nos experts en réparation sont là pour vous offrir leur assistance et restaurer votre appareil à son plein potentiel.</p>
              <p className="text-lg text-gray-600 mb-4">Nos techniciens effectuent un diagnostic complet de votre REDMI NOTE 8 PRO de manière rapide et précise, vous fournissant ainsi les détails de la panne et les coûts de réparation. Avec une moyenne de plus de 450 réparations par mois dans nos boutiques, nous sommes en mesure de choisir les meilleures pièces de remplacement à des prix compétitifs, notamment pour les écrans et les batteries.</p>
              <p className="text-lg text-gray-600">Associé à la formation de nos techniciens et réparateurs, confier la réparation de votre smartphone à 3DMobile garantit une remise en état de votre appareil en 1 heure pour la plupart des problèmes rencontrés. Nous prenons en charge directement en boutique et en temps réel 100% des pannes que votre appareil REDMI NOTE 8 PRO pourrait rencontrer.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4 text-gray-800">Réparations REDMI NOTE 8 PRO</h2>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-white border border-gray-200 rounded-lg overflow-hidden">
              <ScreenRepairService id="glass-cran-compatible" name="Vitre + écran compatible" normalPrice="79.00€ TTC" discountPrice="54.00€ TTC" duration="30 minutes" isSelected={selectedServices.includes("glass-cran-compatible")} selectedProtection={selectedProtection["glass-cran-compatible"]} onToggle={handleServiceToggle} onProtectionSelect={handleProtectionSelect} />
              <ScreenRepairService id="glass-cran-original-xiaomi" name="Vitre + écran Original Xiaomi" normalPrice="129.00€ TTC" discountPrice="104.00€ TTC" duration="30 minutes" isSelected={selectedServices.includes("glass-cran-original-xiaomi")} selectedProtection={selectedProtection["glass-cran-original-xiaomi"]} onToggle={handleServiceToggle} onProtectionSelect={handleProtectionSelect} />
              <StandardService id="glass-arrire" name="Vitre arrière" normalPrice="49.00€ TTC" discountPrice="24.00€ TTC" duration="30 minutes" isSelected={selectedServices.includes("glass-arrire")} onToggle={handleServiceToggle} />
              <StandardService id="glass-camera-arrire" name="Vitre camera arrière" normalPrice="39.00€ TTC" discountPrice="14.00€ TTC" duration="30 minutes" isSelected={selectedServices.includes("glass-camera-arrire")} onToggle={handleServiceToggle} />
              <StandardService id="battery" name="Batterie" normalPrice="39.00€ TTC" discountPrice="14.00€ TTC" duration="45 minutes" isSelected={selectedServices.includes("battery")} onToggle={handleServiceToggle} />
              <StandardService id="charging-port-de-charge" name="Connecteur de charge" normalPrice="39.00€ TTC" discountPrice="14.00€ TTC" duration="30 minutes" isSelected={selectedServices.includes("charging-port-de-charge")} onToggle={handleServiceToggle} />
              <StandardService id="button-home" name="Bouton home" normalPrice="39.00€ TTC" duration="30 minutes" isSelected={selectedServices.includes("button-home")} onToggle={handleServiceToggle} />
              <StandardService id="button-power" name="Bouton power" normalPrice="39.00€ TTC" duration="30 minutes" isSelected={selectedServices.includes("button-power")} onToggle={handleServiceToggle} />
              <StandardService id="button-volume" name="Bouton volume" normalPrice="39.00€ TTC" duration="30 minutes" isSelected={selectedServices.includes("button-volume")} onToggle={handleServiceToggle} />
              <StandardService id="camra-avant" name="Caméra avant" normalPrice="39.00€ TTC" discountPrice="14.00€ TTC" duration="30 minutes" isSelected={selectedServices.includes("camra-avant")} onToggle={handleServiceToggle} />
              <StandardService id="camra-arrire" name="Caméra arrière" normalPrice="49.00€ TTC" discountPrice="24.00€ TTC" duration="30 minutes" isSelected={selectedServices.includes("camra-arrire")} onToggle={handleServiceToggle} />
              <StandardService id="lecteur-empreinte" name="lecteur empreinte" normalPrice="39.00€ TTC" duration="30 minutes" isSelected={selectedServices.includes("lecteur-empreinte")} onToggle={handleServiceToggle} />
              <StandardService id="microphone" name="Micro" normalPrice="39.00€ TTC" discountPrice="14.00€ TTC" duration="30 minutes" isSelected={selectedServices.includes("microphone")} onToggle={handleServiceToggle} />
              <StandardService id="ecouteur-interne" name="Ecouteur interne" normalPrice="39.00€ TTC" discountPrice="14.00€ TTC" duration="30 minutes" isSelected={selectedServices.includes("ecouteur-interne")} onToggle={handleServiceToggle} />
              <StandardService id="speaker" name="Haut parleur" normalPrice="39.00€ TTC" discountPrice="14.00€ TTC" duration="30 minutes" isSelected={selectedServices.includes("speaker")} onToggle={handleServiceToggle} />
              <StandardService id="prise-casque" name="Prise casque" normalPrice="39.00€ TTC" duration="30 minutes" isSelected={selectedServices.includes("prise-casque")} onToggle={handleServiceToggle} />
      ...
      <footer className="bg-gray-800 text-gray-300 py-12">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-gray-400 mb-8 max-w-2xl mx-auto">Votre expert en réparation REDMI NOTE 8 PRO à Saint-Nazaire</p>
