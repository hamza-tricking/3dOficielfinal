...
const lGModels: LGModel[] = [
  { name: "G6", image: "G6_image.png", path: "g6" },
  { name: "K10 2018", image: "K10_2018_image.png", path: "k10-2018" },
  { name: "K4", image: "K4_image.png", path: "k4" },
  { name: "K8 2018", image: "K8_2018_image.png", path: "k8-2018" },
  { name: "Q8", image: "Q8_image.jpg", path: "q8" },
  { name: "V10", image: "V10_image.jpg", path: "v10" }
];

export default function LGModels() {
  return (
        ...
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center py-4">
            ...
            <ul className="hidden md:flex space-x-6">
              ...
              <li><Link href="/reparations/smartphones/lg" className="text-gray-800 hover:text-blue-600 font-semibold transition-colors duration-300 relative group">
                LG
                <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-blue-600 transition-all duration-300 group-hover:w-full"></span>
              </Link></li>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center">
            ...
            <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
              Expert en réparation de tous les modèles LG à Saint-Nazaire
            </p>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
            {lGModels.map((model) => (
              <Link 
                key={model.path}
                href={`/reparations/smartphones/lg/${model.path}`}
              ...
              >
                <div className="aspect-square mb-4 overflow-hidden rounded-lg bg-gray-50 flex items-center justify-center">
                  <Image
                    src={`/scrabed data/smartphones repaire/repair_data_lg/${model.image}`}
                    alt={model.name}
                    width={120}
                    height={120}
      ...
      <section className="py-16 bg-gray-800 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-6">
            Votre LG est en Panne ?
          </h2>
          <p className="text-xl mb-8">
            Nos experts LG vous attendent pour un diagnostic rapide et une réparation de qualité.
          </p>
      ...
      <footer className="bg-gray-800 text-gray-300 py-12">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-gray-400 mb-8 max-w-2xl mx-auto leading-relaxed">
            Votre expert en réparation LG à Saint-Nazaire
          </p>
