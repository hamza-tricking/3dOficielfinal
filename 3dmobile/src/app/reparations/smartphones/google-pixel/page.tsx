...
interface GooglePixelModel {
  name: string;
  image: string;
  path: string;
}

const googlePixelModels: GooglePixelModel[] = [
  { name: "Pixel 3A", image: "PIXEL_3A_image.png", path: "pixel-3a" },
  { name: "Pixel 3A XL", image: "PIXEL_3A_XL_image.png", path: "pixel-3a-xl" },
  { name: "Pixel 4", image: "PIXEL_4_image.png", path: "pixel-4" },
  { name: "Pixel 4A", image: "PIXEL_4A_image.png", path: "pixel-4a" },
  { name: "Pixel 4 XL", image: "PIXEL_4_XL_image.png", path: "pixel-4-xl" },
  { name: "Pixel 5", image: "PIXEL_5_image.png", path: "pixel-5" },
  { name: "Pixel 5A", image: "PIXEL_5A_image.png", path: "pixel-5a" },
  { name: "Pixel 6", image: "PIXEL_6_image.png", path: "pixel-6" },
  { name: "Pixel 6A", image: "PIXEL_6A_image.png", path: "pixel-6a" },
  { name: "Pixel 6 Pro", image: "PIXEL_6_PRO_image.png", path: "pixel-6-pro" },
  { name: "Pixel 7", image: "PIXEL_7_image.png", path: "pixel-7" },
  { name: "Pixel 7 Pro", image: "PIXEL_7_PRO_image.png", path: "pixel-7-pro" },
  { name: "Pixel 8", image: "PIXEL_8_image.jpg", path: "pixel-8" },
  { name: "Pixel 8A", image: "PIXEL_8A_image.jpg", path: "pixel-8a" },
  { name: "Pixel 8 Pro", image: "PIXEL_8_PRO_image.jpg", path: "pixel-8-pro" },
  { name: "Pixel 9", image: "PIXEL_9_image.webp", path: "pixel-9" },
  { name: "Pixel 9 Pro", image: "PIXEL_9_PRO_image.webp", path: "pixel-9-pro" },
];

export default function GooglePixelModels() {
  return (
        ...
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center py-4">
            ...
            <ul className="hidden md:flex space-x-6">
              ...
              <li><Link href="/reparations/smartphones/google-pixel" className="text-gray-800 hover:text-blue-600 font-semibold transition-colors duration-300 relative group">
                Google Pixel
                <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-blue-600 transition-all duration-300 group-hover:w-full"></span>
              </Link></li>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6 text-white">
              Réparation Google Pixel
            </h1>
            <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
              Expert en réparation de tous les modèles Google Pixel à Saint-Nazaire
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4 text-gray-800">
              Choisissez votre modèle Google Pixel
            </h2>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
            {googlePixelModels.map((model) => (
              <Link 
                key={model.path}
                href={`/reparations/smartphones/google-pixel/${model.path}`}
              ...
              >
                <div className="aspect-square mb-4 overflow-hidden rounded-lg bg-gray-50 flex items-center justify-center">
                  <Image
                    src={`/scrabed data/smartphones repaire/repair_data_google_pixel/${model.image}`}
                    alt={model.name}
                    width={120}
                    height={120}
      ...
      <section className="py-16 bg-gray-800 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-6">
            Votre Google Pixel est en Panne ?
          </h2>
          <p className="text-xl mb-8">
            Nos experts Google Pixel vous attendent pour un diagnostic rapide et une réparation de qualité.
          </p>
      ...
      <footer className="bg-gray-800 text-gray-300 py-12">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-gray-400 mb-8 max-w-2xl mx-auto leading-relaxed">
            Votre expert en réparation Google Pixel à Saint-Nazaire
          </p>
