...
const repairServices = [
  { id: "ecran-lcd", name: "Ecran LCD", normalPrice: "189.00€ TTC", discountPrice: "164.00€ TTC", duration: "30 minutes" },
  { id: "glass-tactile", name: "Vitre tactile", normalPrice: "99.00€ TTC", discountPrice: "74.00€ TTC", duration: "30 minutes" },
  { id: "glass-tactile-ecran-lcd", name: "Vitre tactile + Ecran Lcd", normalPrice: "249.00€ TTC", discountPrice: "224.00€ TTC", duration: "30 minutes" },
...
export default function Apple4Page() {
          ...
          <div className="flex flex-col md:flex-row items-center gap-8">
            <div className="md:w-1/2">
              <div className="bg-white rounded-2xl shadow-xl p-8">
                <Image src="/scrabed data/tablettes repaire/tablet_repair_data_apple/default.png" alt="4" width={400} height={400} className="w-full h-auto object-contain" />
              </div>
            </div>
            <div className="md:w-1/2">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-white border border-gray-200 rounded-lg overflow-hidden">
              <ScreenRepairService id="ecran-lcd" name="Ecran LCD" normalPrice="189.00€ TTC" discountPrice="164.00€ TTC" duration="30 minutes" isSelected={selectedServices.includes("ecran-lcd")} selectedProtection={selectedProtection["ecran-lcd"]} onToggle={handleServiceToggle} onProtectionSelect={handleProtectionSelect} />
